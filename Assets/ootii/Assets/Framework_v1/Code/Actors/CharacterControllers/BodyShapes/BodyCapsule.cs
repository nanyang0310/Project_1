...
namespace com.ootii.Actors
{
    ...
    public class BodyCapsule : BodyShape
    {
        ...
        {
            Vector3 lStepOffset = (rMaxStepHeight >= _Radius ? new Vector3(0f, (rMaxStepHeight - _Radius) + 0.01f, 0f) : Vector3.zero);
            Vector3 lBodyShapePos1 = rPositionDelta + (_Transform == null ? _Parent.position + (_Parent.rotation * (_Offset + lStepOffset)) : _Transform.position + (_Transform.rotation * (_Offset + lStepOffset)));
            ...
            if (UnityEditor.EditorApplication.isPlaying)
            {
                ...
                else
                {
                    ...
                    if (lLocalEndPosition == lLocalStartPosition)
                    {
                        ...
                        lStartCollider.radius = _Radius / lScale;
                    ...
                    else
                    {
                        ...
                        int lCount = (int)(lToEnd.magnitude / (_Radius / lScale));
                        ...
                        lEndCollider.radius = _Radius / lScale;
